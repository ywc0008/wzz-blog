export default function Footer() {
  ...
  return (
    <footer className="flex flex-col p-10 bg-neutral text-neutral-content gap-5 justify-center items-center">
      <div className="flex justify-between w-3/4">
        <h1 className="flex justify-center footer-title w-1/3">Logo</h1>
        <nav className="flex justify-center w-1/3">
          <div className="grid grid-flow-col gap-4">
            <a target="_blank" href="https://github.com/ywc0008">
              <svg
                width="32"
                height="32"
                viewBox="0 0 32 32"
      ...
      <span className="flex text-center justify-center items-center text-sm">
        &copy;{`${today.getFullYear()} wzz. All Rights Reserved.`}
      </span>
    </footer>
  );
}
